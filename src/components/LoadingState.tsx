...
export function LoadingState({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center gap-2.5 text-[#78716c] ${compact ? 'py-8' : 'py-16'} ${className}`}
    >
      <Loader2 className="animate-spin text-[#a8a29e]" size={compact ? 18 : 26} />
