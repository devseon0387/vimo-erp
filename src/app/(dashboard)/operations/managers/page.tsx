    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900">매니저</h1>
          <p className="text-gray-500 mt-2">매니저 정보를 확인하고 관리해요</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-divider p-5">
          <p className="text-2xl font-bold text-green-600">{managers.filter((p) => p.status === 'active').length}</p>
        ...
        <div className="p-6">
          {managers.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-400 text-sm">등록된 매니저가 없습니다</p>
            </div>
          ) : (
          ...
          <div className="flex min-h-full items-end sm:items-center justify-center p-0 sm:p-4">
            ...
            >
              <div className="px-6 sm:px-8 pt-8 pb-6">
                ...
                <h2 className="text-page mb-2">새 매니저를<br />추가할게요</h2>
                <p className="text-sm text-gray-500">매니저 정보를 입력해주세요</p>
              </div>
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <div className="px-6 py-4 border-b border-divider">
                <h2 className="text-xl font-bold text-gray-900">매니저 삭제</h2>
              </div>
              <div className="p-6">
