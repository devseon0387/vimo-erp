...
export default function InboxPage() {
  ...
  return (
    <div style={{ maxWidth: '960px', margin: '0 auto' }} className="space-y-6">
      {/* 헤더 */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">받은 메일함</h1>
      ...
      <div className="bg-white rounded-lg shadow" style={{ border: '1px solid #ede9e6' }}>
        <div style={{ padding: '16px 24px', borderBottom: '1px solid #f0ece9' }}>
          <div className="flex items-center gap-2">
            <Inbox size={20} style={{ color: '#f97316' }} />
            <h2 style={{ fontSize: '16px', fontWeight: 600, color: '#1c1917' }}>받은 메일함</h2>
        ...
        {loading ? (
          ...
          <div style={{ padding: '48px 24px', textAlign: 'center' }}>
            ...
            <p style={{ color: '#a8a29e', fontSize: '14px', marginTop: '12px' }}>받은 메일이 없습니다.</p>
          </div>
        ) : (
          <div>
            {emails.map(email => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: '8px' }}>
                    ...
                    <span style={{ fontSize: '12px', color: '#a8a29e', flexShrink: 0 }}>{formatDate(email.date)}</span>
                  </div>
