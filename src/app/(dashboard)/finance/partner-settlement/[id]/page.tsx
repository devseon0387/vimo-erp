 ...
 * 기존 경로는 role=partner로 리다이렉트(북마크·외부 링크 보존). year/month 쿼리도 유지.
 */
export default async function PartnerSettlementRedirect({
  params,
  searchParams,
}: {
  ...
  const qs = new URLSearchParams({ role: 'partner' });
